...
<p align="center">
    ...
    <a href="https://www.npmjs.com/package/@keycloakify/keycloak-account-ui/v/25.0.4-rc.0">
...
past [the source files](https://unpkg.com/browse/@keycloakify/keycloak-account-ui@25.0.4-rc.0/src/) that you want to modify into your codebase.
...
> You can browse the sources includes int the NPM package [here](https://unpkg.com/browse/@keycloakify/keycloak-account-ui@25.0.4-rc.0/src/).

## Installation

> **Note:** This README file is automatically generated at build so the information above are guaranteed to be up to date.  
> You are currently viewing the README of [`@keycloakify/keycloak-account-ui@25.0.4-rc.0`](https://www.npmjs.com/package/@keycloakify/keycloak-account-ui/v/25.0.4-rc.0) that
...
{
  "dependencies": {
    "@keycloakify/keycloak-account-ui": "25.0.4-rc.0",
...
You can browse the sources files **[here](https://unpkg.com/browse/@keycloakify/keycloak-account-ui@25.0.4-rc.0/src/)**.
