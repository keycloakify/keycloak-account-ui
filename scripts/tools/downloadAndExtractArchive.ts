...
namespace SuccessTracker {
  ...
  export async function removeFromDownloaded(params: {
    ...
    successTracker.archiveFileBasenames =
      successTracker.archiveFileBasenames.filter(
  ...
  export async function removeFromExtracted(params: {
    ...
    successTracker.extractDirBasenames =
      successTracker.extractDirBasenames.filter(
